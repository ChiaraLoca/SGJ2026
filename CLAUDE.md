# CLAUDE.md — 4E: Le Menti

Questo file guida Claude Code nel progetto Unity. Leggilo integralmente prima di generare qualsiasi codice.
...
## Workflow Atteso da Claude Code
