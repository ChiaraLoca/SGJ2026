...
| Protezione Costituzione | `SetConstitutionProtectionChange` + contratti beneficio positivo | Annulla nel `GameContext` aumenti di Note e carte concessi dalle carte avversarie fino al prossimo turno |
