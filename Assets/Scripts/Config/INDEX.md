...
| [GameConstants.cs](GameConstants.cs) | `static GameConstants` | Costanti **non** configurabili: giocatori/comandanti, setup mano, indici slot, round ed ancoraggio UI centrale `UiCenterAnchor` |
