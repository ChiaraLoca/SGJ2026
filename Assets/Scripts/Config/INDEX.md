...
| [GameConstants.cs](GameConstants.cs) | `static GameConstants` | Costanti **non** configurabili: giocatori/comandanti, setup mano, indici slot, round, conversione indice/conteggio ed ancoraggio UI centrale |
